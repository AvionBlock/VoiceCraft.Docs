...
export const docsNavigation: DocsNavigationGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'VoiceCraft.Java', labelKey: 'navigation.items.voiceCraftJava', to: '/ecosystem/voicecraft-java' },
      ...
      { label: 'Direct Paper', labelKey: 'navigation.items.directPaper', to: '/ecosystem/voicecraft-java-direct-paper' },
      { label: 'Proxy', labelKey: 'navigation.items.proxy', to: '/ecosystem/voicecraft-java-proxy' },
