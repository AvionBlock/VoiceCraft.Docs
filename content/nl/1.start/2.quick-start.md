...
- Bedrock dedicated server: lees [McHttp voor BDS](/nl/minecraft/mchttp-bds)
- Java + Geyser-server: lees [GeyserVoice] (/nl/ecosystem/geyservoice)

## 1. Download de server

1. Open de [downloadpagina](/nl/download).
...
Als u vanaf de broncode bouwt, raadpleeg dan [VoiceCraft-repository en build](/nl/ecosystem/voicecraft-repository).
...
Zie [Transportmodi](/nl/server/transports) voor de volledige vergelijking.

## 5. Download de client

Download vanaf de [downloadpagina](/nl/download) het pakket voor uw spelers:
...
- Gebruik voor Bedrock Dedicated Server [McHttp for BDS](/nl/minecraft/mchttp-bds).
- Gebruik voor een lokale Bedrock-wereld [McWss voor singleplayer-werelden] (/nl/minecraft/mcwss-singleplayer).
- Gebruik voor Java + Geyser/Floodgate [GeyserVoice](/nl/ecosystem/geyservoice).

Als u op Bedrock implementeert, houd dan deze twee pagina's bij de hand:

- [Downloadpagina](/nl/download) voor onbewerkte client/server/addon-releasebestanden
...
- [Serverinstallatie](/nl/server/installation)
- [Eerste serverrun] (/nl/server/first-run)
- [ServerProperties.json](/nl/server/server-properties)
- [Runtime-overschrijvingen] (/nl/server/runtime-overrides)
- [Transportmodi](/nl/server/transports)
