...
3. `VoiceCraft.Addon.Core.McHttp.zip` from releases, or a ready world archive from the [Addon Configurator](/nl/addon-configurator)
...
- [Addon Configurator](/nl/addon-configurator) als u een kant-en-klaar wereldarchief wilt
- [Downloadpagina](/nl/download) als u het onbewerkte add-on-releasepakket wilt
...
- [VoiceCraft.Addon] (/nl/ecosystem/voicecraft-addon)
