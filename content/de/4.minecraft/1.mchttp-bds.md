...
3. `VoiceCraft.Addon.Core.McHttp.zip` from releases, or a ready world archive from the [Addon Configurator](/de/addon-configurator)
...
- [Addon-Konfigurator](/de/addon-configurator), wenn Sie ein sofort entpackbares Weltarchiv wünschen
- [Download-Seite](/de/download), wenn Sie das Roh-Add-on-Release-Paket möchten
...
- [VoiceCraft.Addon](/de/ecosystem/voicecraft-addon)
