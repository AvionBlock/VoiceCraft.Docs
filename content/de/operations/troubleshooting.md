...
Wenn der Server von systemd, Docker, einem Panel oder VoiceCraft.Java-Autostart verwaltet wird, überprüfen Sie die Startargumente sowie die JSON-Datei.
...
## VoiceCraft.Java funktioniert nicht
