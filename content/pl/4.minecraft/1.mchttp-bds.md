...
3. `VoiceCraft.Addon.Core.McHttp.zip` from releases, or a ready world archive from the [Addon Configurator](/pl/addon-configurator)
...
- [Konfigurator dodatków](/pl/addon-configurator), jeśli chcesz mieć gotowe do rozpakowania archiwum świata
- [Strona pobierania](/pl/download), jeśli chcesz otrzymać surowy pakiet wydań dodatków
