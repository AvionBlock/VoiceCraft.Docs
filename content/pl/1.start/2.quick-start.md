...
- Serwer dedykowany Bedrock: czytaj [McHttp for BDS](/pl/minecraft/mchttp-bds)
- Serwer Java + Geyser: czytaj [GeyserVoice](/pl/ecosystem/geyservoice)

## 1. Pobierz serwer

1. Otwórz [stronę pobierania](/pl/download).
...
Jeśli budujesz ze źródła, zobacz [Repozytorium i kompilacja VoiceCraft](/pl/ecosystem/voicecraft-repository).
...
Pełne porównanie znajdziesz w [Tryby transportu](/pl/server/transports).

## 5. Pobierz klienta

Ze [strony pobierania](/pl/download) pobierz pakiet dla swoich graczy:
...
- W przypadku serwera dedykowanego Bedrock użyj [McHttp for BDS](/pl/minecraft/mchttp-bds).
- W przypadku lokalnego świata Bedrock użyj [McWss dla światów dla jednego gracza](/pl/minecraft/mcwss-singleplayer).
- W przypadku Java + Geyser/Floodgate użyj [GeyserVoice](/pl/ecosystem/geyservoice).

Jeśli wdrażasz na Bedrock, trzymaj te dwie strony w pobliżu:

- [Strona pobierania](/pl/download) dla surowych plików wersji klienta/serwera/dodatków
