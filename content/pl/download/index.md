...
Wdrożenia serwera dedykowanego Bedrock wymagają także pakietu `VoiceCraft.Addon.Core.McHttp` lub skonfigurowanego archiwum świata z [konfiguratora dodatku](/addon-configurator). Lokalne światy Bedrock zwykle używają `VoiceCraft.Addon.Core.McWss`. Wdrożenia Java/Geyser korzystają z `VoiceCraft.Java` i transportu `McTcp`.
