...
|-----------|------------------|----------------|----------|-------------|
| `McHttp` | `VoiceCraft.Addon.Core.McHttp` | HTTP端点 | 基岩专用服务器 | `McHttpConfig.LoginToken` |
| `McWss` | `VoiceCraft.Addon.Core.McWss` | websocket + 命令隧道 | 当地基岩世界和测试 | `McWssConfig.LoginToken` |
...
`McWss` 公开一个 websocket 端点并在基岩世界中使用命令隧道。
