...
3. `VoiceCraft.Addon.Core.McHttp.zip` from releases, or a ready world archive from the [Addon Configurator](/zh_cn/addon-configurator)
4. BDS具有所需模块和脚本API支持
...
- [插件配置器](/zh_cn/addon-configurator) 如果您想要一个可立即解压的世界存档
- [下载页面](/zh_cn/download) 如果您想要原始插件发布包
...
- [VoiceCraft.Addon](/zh_cn/ecosystem/voicecraft-addon)
- [插件 API](/zh_cn/ecosystem/addon-api)
- [下载页面](/zh_cn/download)
