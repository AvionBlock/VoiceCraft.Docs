...
- `McTcpConfig.LoginToken` for VoiceCraft.Java / Java bridge
...
If `VoiceCraft.Java` manages the VoiceCraft runtime:
...
For `VoiceCraft.Java`, keep these staff-only:
...
- VoiceCraft.Java operational commands restricted
