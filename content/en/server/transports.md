...
| `McTcp` | `VoiceCraft.Java` | raw TCP bridge | Java, Geyser, proxy, or Paper bridge scenarios | `McTcpConfig.LoginToken` |
...
- aligns with current `VoiceCraft.Java` architecture
