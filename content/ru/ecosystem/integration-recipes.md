...
- BDS может достичь конечной точки HTTP VoiceCraft.
...
7. подключить клиента и подтвердить изменение близости движением
...
- доступен поток веб-сокета `/connect`
...
5. перезагрузите и проверьте поток привязки
