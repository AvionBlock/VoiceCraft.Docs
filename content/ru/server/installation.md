...
- `McWss` транспорт для потоков веб-сокетов/командных туннелей Bedrock
...
8. Добавьте конечную точку VoiceCraft UDP в клиенте.
9. Подключите сторону Minecraft с помощью соответствующего дополнения или руководства по плагину.
