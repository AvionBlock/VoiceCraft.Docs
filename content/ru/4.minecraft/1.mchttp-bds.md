...
3. `VoiceCraft.Addon.Core.McHttp.zip` из релизов или готовый world-архив из [конфигуратора аддона](/ru/addon-configurator)
...
- [Конфигуратор аддона](/ru/addon-configurator), если нужен готовый архив для распаковки в мир
- [Страница скачивания](/ru/download), если нужен сырой release package аддона
