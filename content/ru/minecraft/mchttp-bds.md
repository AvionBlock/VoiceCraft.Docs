...
3. `VoiceCraft.Addon.Core.McHttp.zip` из релизов или готовый world-архив из [конфигуратора аддона](/addon-configurator)
...
- [Конфигуратор аддона](/addon-configurator), если нужен готовый архив для распаковки в мир
- [Страница скачивания](/download), если нужен сырой release package аддона
